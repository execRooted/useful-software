...
class ControlPanel(Static):
    def compose(self) -> ComposeResult:
        ...
        yield Button("Shutdown & Clear Bin", id="shutdown", variant="error")
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        match event.button.id:
            ...
            case "shutdown":
                ...
                time.sleep(2)
                os.system("shutdown /s /f /t 0" if sys.platform == "win32" else "shutdown now")
