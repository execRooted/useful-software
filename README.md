...
- To install the program, download the .zip file, put the clp folder somewhere in your computer and install the requirements.txt (visit the help section down below if you dont know how). Then create a shortcut for clp_mon.pyw and place it into the startup folder.<br>
